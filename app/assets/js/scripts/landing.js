        ...
        if(m.context === 'validateJava'){
            if(m.result == null){
                ...
                setOverlayContent(
                    ...
                    'In order to join Dimensia, you need a 64-bit installation of Java 8. Would you like us to install a copy?',
                    'Install Java',
                    'Install Manually'
                )
                setOverlayHandler(() => {
            ...
            if(login && allGood) {
                ...
                const gameStateChange = function(data){
                    ...
                    if(SERVER_JOINED_REGEX.test(data)){
                        ...
                        DiscordWrapper.updateDetails('Sailing to Dimensia!')
                    }
                }
